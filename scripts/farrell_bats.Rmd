...
bat_tree <- readRDS("../../virionette/04_predictors/bat-supertree_clean.rds")

dat <- read.csv("../../virionette/03_interaction_data/virionette.csv", as.is=T)
...
```{r betacov_phylo_cv, echo=TRUE, eval=FALSE}
## indexing 10-folds of interactions
folds <- cross.validate.fold(com, n = 10, min.per.col=2)  
